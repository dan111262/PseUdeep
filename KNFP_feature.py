...
def coden(seq,kmer,tris):
    ...
    vectors = np.zeros((31, len(coden_dict.keys())))
...
def dealwithdata(protein):
    ...
    dataX = []
    dataY = []
    with open('E:/PseUdeep_master/data/S_627.txt') as f:
        for line in f:
            if '>' not in line:
...
tris2 = get_2_trids()
tris3 = get_3_trids()
protein = 'E:/PseUdeep_master/data/S_627.txt'
indataX = dealwithdata(protein)
np.save('E:/PseUdeep_master/feature/KNFP/S_627_indataX.npy',indataX)
